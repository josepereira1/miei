...
GLuint vertexCount, vertices, normals, texCoord, indices, indCount, 
	texIDCylinder, texIDFloor, texCoords;
...
void prepareCylinder(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
		...
		t[vertex*2 + 0] = 0.4375;	//	ESTES VALORES CORRESPONDEM AOS PÍXEIS DA IMAGEM, NO CENTRO DA CIRCUNFERÊNCIA [VER SLIDES]
		t[vertex*2 + 1] = 0.1875;	
		...
		t[vertex*2 + 0] = 0.8125;	//	ESTES VALORES CORRESPONDEM AOS PÍXEIS DA IMAGEM, NO CENTRO DA CIRCUNFERÊNCIA [VER SLIDES]
		t[vertex*2 + 1] = 0.1875;	
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(float) * 2 * vertex, t, GL_STATIC_DRAW);
