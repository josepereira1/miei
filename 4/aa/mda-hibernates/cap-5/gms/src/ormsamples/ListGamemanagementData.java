...
import org.orm.*;
public class ListGamemanagementData {
	...
	public static void main(String[] args) {
		try {
			ListGamemanagementData listGamemanagementData = new ListGamemanagementData();
			try {
				listGamemanagementData.listTestData();
				//listGamemanagementData.listByCriteria();
			}
			finally {
