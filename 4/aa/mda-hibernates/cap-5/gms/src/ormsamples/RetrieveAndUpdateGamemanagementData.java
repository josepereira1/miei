...
import org.orm.*;
public class RetrieveAndUpdateGamemanagementData {
	...
	public void retrieveByCriteria() throws PersistentException {
		...
		//lptuminhodiaaUserCriteria.name.eq();
		...
		// Please uncomment the follow line and fill in parameter(s)
		//lptuminhodiaaGameCriteria.name.eq();
		...
		// Please uncomment the follow line and fill in parameter(s)
		//lptuminhodiaaPlatformCriteria.name.eq();
	...
	public static void main(String[] args) {
		try {
			RetrieveAndUpdateGamemanagementData retrieveAndUpdateGamemanagementData = new RetrieveAndUpdateGamemanagementData();
			try {
				retrieveAndUpdateGamemanagementData.retrieveAndUpdateTestData();
				//retrieveAndUpdateGamemanagementData.retrieveByCriteria();
			}
			finally {
