...
public class User {
	...
	public final pt.uminho.di.aa.GameSetCollection games = new pt.uminho.di.aa.GameSetCollection(this, _ormAdapter, ORMConstants.KEY_USER_GAMES, ORMConstants.KEY_MUL_MANY_TO_MANY);
