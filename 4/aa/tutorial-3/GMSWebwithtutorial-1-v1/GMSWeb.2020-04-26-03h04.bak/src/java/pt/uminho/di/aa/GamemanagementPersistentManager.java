...
public class GamemanagementPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Gamemanagement";
	...
	private GamemanagementPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GamemanagementPersistentManager();
		}
