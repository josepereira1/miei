...
public class PlatformDAO {
	public static Platform loadPlatformByORMID(String name) throws PersistentException {
		try {
			PersistentSession session = GamemanagementPersistentManager.instance().getSession();
	...
	public static Platform loadPlatformByORMID(PersistentSession session, String name) throws PersistentException {
		try {
			return (Platform) session.load(pt.uminho.di.aa.Platform.class, name);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform getPlatformByORMID(PersistentSession session, String name) throws PersistentException {
		try {
			return (Platform) session.get(pt.uminho.di.aa.Platform.class, name);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform loadPlatformByORMID(PersistentSession session, String name, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Platform) session.load(pt.uminho.di.aa.Platform.class, name, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform getPlatformByORMID(PersistentSession session, String name, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Platform) session.get(pt.uminho.di.aa.Platform.class, name, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().saveObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().deleteObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().getSession().refresh(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(pt.uminho.di.aa.Platform platform) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().getSession().evict(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
