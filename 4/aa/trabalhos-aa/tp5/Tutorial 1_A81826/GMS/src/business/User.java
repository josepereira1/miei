...
public class User {
	...
	public final business.GameSetCollection games = new business.GameSetCollection(this, _ormAdapter, ORMConstants.KEY_USER_GAMES, ORMConstants.KEY_MUL_MANY_TO_MANY);
