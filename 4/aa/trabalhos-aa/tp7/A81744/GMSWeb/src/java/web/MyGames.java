...
public class MyGames extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String action = request.getParameter("myGamesAction");      
        
        // method = GET, simplesmente apresenta a página "My Games"
        if (action == null) displayUserGames(request, response);
        ...
        if (action.equals("allgames")) request.getRequestDispatcher("/AllGames").forward(request, response);
    ...
    private void displayUserGames(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        IGMS gms = GMS.getGMS();
        try {
            Collection<Game> games = gms.getUserGames(username, Login.getPersistentSession(request));
