...
public class GameDAO {
	...
	public static Game loadGameByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Game) session.load(pt.uminho.di.aa.Game.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game getGameByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Game) session.get(pt.uminho.di.aa.Game.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game loadGameByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Game) session.load(pt.uminho.di.aa.Game.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game getGameByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Game) session.get(pt.uminho.di.aa.Game.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().saveObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().deleteObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().getSession().refresh(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(pt.uminho.di.aa.Game game) throws PersistentException {
		try {
			GamemanagementPersistentManager.instance().getSession().evict(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
