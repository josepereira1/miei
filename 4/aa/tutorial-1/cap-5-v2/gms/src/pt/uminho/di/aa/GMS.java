...
public class GMS {
    ...
    public static void registerGame(Game game, PersistentSession session) throws PersistentException, GameExistsException, InvalidParametersException {
    ...
    public static void addGameToPersonalLibrary(String username, String gameName, PersistentSession session) throws PersistentException, UserNotExistsException, InvalidParametersException, GameNotExistsException {
