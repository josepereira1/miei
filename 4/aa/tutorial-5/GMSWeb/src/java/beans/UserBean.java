...
public class UserBean implements UserBeanLocal {
    ...
    public User getUserDetails(String name) throws PersistentException, UserNotExistsException{
        if(name != null && containsUser(name)){
            return UserDAO.getUserByORMID(name);
        }else throw new UserNotExistsException(name);
    }
